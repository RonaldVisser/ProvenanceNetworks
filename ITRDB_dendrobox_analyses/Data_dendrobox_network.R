...
ggplot(network_4, aes(x=distance_m)) + geom_density(fill = "grey", alpha = .5) + scale_x_continuous(label=unit_format(unit="km", scale=0.001))
ggsave("Network_4_distance_density.png")
...
ggplot(network_4_qusp, aes(x=distance_m)) + geom_density() + scale_x_continuous(label=unit_format(unit="km", scale=0.001))
ggsave("Network_4_QUSP_distance_density.png")
ggplot(network_4_qusp, aes(x=distance_m)) + geom_histogram() + scale_x_continuous(label=unit_format(unit="km", scale=0.001))
...
ggplot(network_4_abal, aes(x=distance_m)) + geom_density() + scale_x_continuous(label=unit_format(unit="km", scale=0.001))
ggsave("Network_4_ABAL_distance_density.png")
ggplot(network_4_abal, aes(x=distance_m)) + geom_histogram() + scale_x_continuous(label=unit_format(unit="km", scale=0.001))
...
ggplot(network_4_pisy, aes(x=distance_m)) + geom_density() + scale_x_continuous(label=unit_format(unit="km", scale=0.001))
ggsave("Network_4_PISY_distance_density.png")
ggplot(network_4_pisy, aes(x=distance_m)) + geom_histogram() + scale_x_continuous(label=unit_format(unit="km", scale=0.001))
...
ggplot(network_4_species, aes(x=distance_m, fill = species)) + geom_density(alpha=.5) + scale_x_continuous(label=unit_format(unit="km", scale=0.001))
ggsave("Network_4_Species_distance_histogram_density.png")
...
ggplot(network_4_species, aes(x=distance_m, fill = species)) + geom_density(data=network_4, fill = 'grey', alpha=.5) + geom_density(alpha=.5) + geom_density(data=network_4, fill = 'grey', alpha=.5) + scale_x_continuous(label=unit_format(unit="km", scale=0.001))
